...
CREATE TABLE `compra` (
  ...
  CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`codigoProduto`) REFERENCES `produto` (`codigo`),
  CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`codigoCliente`) REFERENCES `cliente` (`codCliente`)
